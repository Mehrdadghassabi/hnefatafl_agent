...
def run_game_random(screen=None):
    ...
    while 1:
        ...
        if screen is not None:
            tafl.update_image(screen, board, move, "tafl")
    ...
    while 1:
        ...
        if move.king_killed:
            ...
            return a_game_states, a_predicted_scores[1:], d_game_states, d_predicted_scores[
                                                                         1:]  # i.e. the corrected scores from RL
        if screen is not None:
            g.update_image(screen, board, move, "", "")
            pygame.display.update()
...
def main():
    ...
    while num_train_games < 10000:
        ...
        a_game_states, a_corrected_scores, d_game_states, d_corrected_scores = run_game_cacd_RL(attacker_model,
                                                                                                defender_model, screen)
